    ...
    <footer className="w-full max-w-screen-xl space-y-8">
      <div className="grid md:grid-cols-3 gap-4">
        <div className="space-y-4 md:col-span-2">
          <Heading tag="h3" size="text-2xl">
            {t('footer.title')}
          </Heading>
          <Button variant="default" aria-label="hello.about@gmail.com">
            <ArrowRight size={ICONS_SIZES.sm} />
            hello.about@gmail.com
          </Button>
        </div>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <p className="text-sm text-muted-foreground">
          {t('footer.subtitle')}{' '}
          <a href="www.linkedin.com/in/maelacudini" target="_blank" rel="noopener noreferrer">
            @maelacudini
          </a>
        </p>
